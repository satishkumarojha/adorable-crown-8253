import {
  ...
  export default function Teams() {
    return (
        <Stack margin={"auto"} justify={"center"}>
      <Stack minH={'80vh'} width={"90%"} marginBottom={"40px"} direction={{ base: 'column', md: 'row' }}>
       ...
       <Stack minH={'40vh'} width={"80%"} marginBottom={"40px"} direction={{ base: 'column', md: 'row' }}>
       <Flex p={8} flex={1} align={'center'} justify={'center'}>
         <Stack spacing={6} w={'full'} maxW={'lg'}>
           <Text
               as={'span'}
       ...
       <Stack minH={'80vh'} width={"80%"} marginBottom={"40px"} direction={{ base: 'column', md: 'row' }}>
       <Flex p={10} flex={0.75}>
         <Image
           alt={'Login Image'}
           objectFit={'cover'}
